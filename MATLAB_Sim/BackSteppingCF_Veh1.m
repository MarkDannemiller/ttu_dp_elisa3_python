...
P_t = interp1(Veh0_Time_Step,Veh0_Pos,t); %target vehicle (Vehicle 0) position 
V_t = interp1(Veh0_Time_Step,Veh0_Spd,t); %target vehicle (Vehicle 0) speed
...
[GAMMA1,~] = ComputeGamma1(delta_0,h,k_1_1,k_1_2,k_1_3,e_1_1,e_1_2,e_1_3);
